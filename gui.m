...
% Last Modified by GUIDE v2.5 28-May-2022 12:08:09
...
set(handles.edit11,'String',num2str(Contrast(1)));
set(handles.edit12,'String',num2str(Contrast(2)));
set(handles.edit13,'String',num2str(Contrast(3)));
set(handles.edit14,'String',num2str(Contrast(4)));
set(handles.edit15,'String',num2str(mean(Contrast)));
...
set(handles.uitable3,'Data',data,'ForegroundColor',[0 0 0])
...
tableData = get(handles.edit15, 'String');
Z = 10*log10(1/str2num(tableData));
y = hasil1.predict(Z);
